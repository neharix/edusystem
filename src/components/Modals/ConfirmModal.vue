          ...
          <div v-if="isOpen" class="bg-white dark:bg-[#171131] p-6 rounded-2xl shadow-xl w-96">
            ...
            <div class="flex justify-end mt-5 space-x-2">
              ...
              <button @click="$emit('submit')"
                class="select-none px-4 py-2 text-[0.8rem] font-medium bg-blue-400 hover:bg-blue-500 transition ease-in hover:ease-out duration-200 text-white dark:bg-blue-700 dark:hover:bg-blue-800 border border-gray-200 rounded-lg focus:z-10 focus:ring-2 focus:ring-blue-500 dark:border-gray-700  dark:focus:ring-blue-700">
                Hawa
              </button>
            </div>
          </div>
