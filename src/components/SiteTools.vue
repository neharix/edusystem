<template>
  <div :class="class">
    <div class="hidden lg:flex lg:items-center space-x-2">
      ...
      <button-with-tooltip v-if="role === 'root'" text="Umumy import" position-classes="right-30"
    ...
    <div class="flex items-center space-x-2 lg:hidden">
      <button text="Sazlamalar" @click="toggleMobileMenu">
      ...
      <transition name="fade-scale" @before-enter="el => (el.style.display = 'block')"
        ...
        <div v-show="isMobileMenuOpen"
          ...
          <button v-if="role === 'root'" class="flex items-center space-x-2 w-full" @click="emit('toggle-theme')">
