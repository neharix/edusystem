  ...
  <div class="tile mb-6">
    ...
    <div class="my-3">
      <select class="w-full border border-gray-300 rounded-md p-2 focus:outline-none" v-model="selectedFacultyId">
        <option v-for="faculty in highSchoolFaculties" class="text-gray-600 dark:bg-[#171131ef] dark:text-white"
          :key="faculty.id" :value="faculty.id">{{ faculty.name }} fakulteti</option>
      </select>
    </div>
    <div>
