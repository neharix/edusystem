...
const data = ref([
  {id: 1, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
  {id: 2, name: 'asdcfvgbhnjmk', students_count: 20, male_count: 20, female_count: 10},
  {id: 3, name: 'yhgfdsdgrth', students_count: 10, male_count: 40, female_count: 10},
  {id: 4, name: 'ythrgef', students_count: 10, male_count: 20, female_count: 80},
  {id: 5, name: 'rmifmbmrsmwdmgv', students_count: 10, male_count: 20, female_count: 10},
  {id: 6, name: 'fdikmgwedsmgi', students_count: 10, male_count: 20, female_count: 10},
  {id: 7, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
  {id: 7, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
  {id: 7, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
  {id: 7, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
  {id: 7, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
  ...
  {id: 7, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
  {id: 7, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
  {id: 8, name: 'Андрей Иванов', students_count: 10, male_count: 20, female_count: 10},
]);
  ...
  <div class="w-full">
    <div class="w-full flex justify-end mb-8">
      <div id="dropdown" class="relative inline-block text-left">
        <div>
          ...
          >
            Tablisanyň setir sany: {{ rowsPerPage }}
          </button>
        </div>
        ...
        >
          <div
            v-show="isOpen"
            class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white dark:bg-[#171131ef] shadow-lg ring-1 ring-white dark:ring-gray-800 ring-opacity-5"
          >
            <div class="py-1">
    ...
    <div class="w-full overflow-x-auto rounded-lg shadow-lg">
      <table class="w-full min-w-full table-auto bg-white dark:bg-[#171131ef]">
        ...
        <tr>
          <th
            class="border-y border-gray-300 dark:border-[#171131ef] p-3 select-none text-left text-[0.8rem]"
          >
            T/B
          </th>
          <th
            class="border-y border-gray-300 dark:border-[#171131ef] dark:hover:bg-[#32237cef] p-3 select-none cursor-pointer hover:bg-gray-300  text-left text-[0.8rem]"
            @click="sort('name')"
          >
            ÝOKARY OKUW MEKDEBI
        ...
        <tbody>
        <tr v-for="(item, index) in paginatedData" :key="item.id" class="hover:bg-gray-100 dark:hover:bg-[#261953]">
    ...
    <!-- Пагинация с нумерованными страницами -->
    <div class="flex justify-center items-center mt-4 space-x-2 overflow-x-auto">
      ...
      <!-- Последняя страница (если она далеко от текущей) -->
      ...
      <button :class="activeBtnClasses"
              v-if="currentPage !== totalPages" @click="changePage(currentPage + 1)">
        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
