...
<template>
  <div class="w-full">
    ...
    <faculties-data-table :data="facultiesAdditional" @update="facultiesStore.getAllAdditional()" v-if="user.is_superuser"></faculties-data-table>
    <faculties-data-table :data="facultiesAdditional" @update="facultiesStore.getAllAdditional()" v-else></faculties-data-table>
  </div>
</template>
